   ...
   <section id="contact" class="py-3">
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-9">
            <div class="row">
            <c:forEach var="b_list" items="${booklist }"> 
               <div class="col-md-3">
                  <div class="card mb-3">
                     <div class="card-body p-0">
                        <a href="book_detail.?book_no=1&query=${b_list.book_title }"><img class="card-image-top img-fluid" width="100%" alt="${b_list.book_image }" src="${b_list.book_image }"></a>
                        <div class="card-body">
                           <div class="card-title">
                              <div class="book-title" id="book-title">${b_list.book_title }</div>
                              <h6 class="book-author">${b_list.book_author }</h6>
                           </div>
                        </div>
                     </div>
                  </div>
